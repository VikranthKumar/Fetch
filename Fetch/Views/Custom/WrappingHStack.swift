...
struct WrappingHStack: Layout {
    ...
    @inlinable init(alignment: Alignment = .center, horizontalSpacing: CGFloat? = nil, verticalSpacing: CGFloat? = nil) {
...
extension WrappingHStack {
    ...
    func arrangeRows(proposal: ProposedViewSize, subviews: Subviews, cache: inout Cache) -> [Row] {
        if subviews.isEmpty {
            return []
        }
